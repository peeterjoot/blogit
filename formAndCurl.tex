...
\end{aligned}
\end{equation}
The \R{3} part of the lemma follows from \cref{lemma:formAndCurl:660}.
\end{proof}
...
\begin{equation*}
\spacegrad \cdot \lr{ \Ba \cross \Bb } = \Bb \cross \lr{ \spacegrad \cross \Ba } - \Ba \cross \lr{ \spacegrad \cross \Bb }
\end{equation*}
} % lemma
\begin{proof}
