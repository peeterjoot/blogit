...
\end{aligned}
\end{equation}
We can also write \cref{eqn:reciprocalAndTangentspace:920} as
...
\begin{aligned}
   \Bx^a &= J \lr{ J^\T G J }^{-1} \begin{bmatrix} 1 \\ 0 \end{bmatrix} \\
   \Bx^b &= J \lr{ J^\T G J }^{-1} \begin{bmatrix} 0 \\ 1 \end{bmatrix}.
\end{aligned}
\end{equation}
...
Also note that in the case where the number of parameters equals the dimension of the vector space, we can simplify  \( J \lr{ J^\T G J }^{-1} \) considerably.  That becomes
