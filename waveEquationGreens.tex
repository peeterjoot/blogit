...
\section{2nd attempted verification of the claimed 2D Green's function.}
...
\end{equation}
\section{Deriving the Green's functions.}
...
\end{equation}
\subsection{Evaluating the 1D Green's function}
...
\subsection{The convolution integrals.}
...
g(x', t').
\end{equation}
\subsection{2D Green's function derivation.}
...
\subsection{3D Green's function derivation.}
...
Evaluating the \( \omega \) integral first with an upper half plane contour, we have
