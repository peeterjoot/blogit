...
A special application of the above properties is
\maketheorem{Wedge product filtering property.}{thm:vectorBivector:9}{
\begin{equation*}
...
\end{aligned}.
\end{equation}
Observe that this is the Cramer's rule solution for \( b, d \).  We may similarly solve for \( a, c \) by wedging with \( \By \).
