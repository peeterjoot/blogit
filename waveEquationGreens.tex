...
\spacegrad X^{-1/2} &= \frac{r \rcap}{c^2 X^{3/2}} \\
\spacegrad X^{-3/2} &= \frac{3 r \rcap}{c^2 X^{5/2}} \\
\spacegrad \Theta &= -\frac{\delta \rcap}{c} \\
\spacegrad \delta &= -\frac{\rcap \delta'}{c} \\
\spacegrad \cdot \rcap &= \frac{1}{r}.
\end{aligned}
\end{equation}

Now for our real computations.
\begin{equation}\label{eqn:waveEquationGreens:560}
\begin{aligned}
\spacegrad \frac{\Theta}{X^{1/2}}
&=
X^{-1/2} \spacegrad \Theta + \Theta \spacegrad X^{-1/2} \\
&=
- X^{-1/2} \frac{\rcap}{c} \delta
+ X^{-3/2} \frac{r \rcap }{c^2} \Theta,
\end{aligned}
\end{equation}
and
\begin{equation}\label{eqn:waveEquationGreens:n}
\begin{aligned}
\spacegrad^2 \frac{\Theta}{X^{1/2}}
&=
\spacegrad \cdot \lr{
    - X^{-1/2} \frac{\rcap}{c} \delta
    + X^{-3/2} \frac{r \rcap }{c^2} \Theta
...
&=
\lr{ \spacegrad \cdot \rcap } \lr{
    - X^{-1/2} \frac{1}{c} \delta
    + X^{-3/2} \frac{r}{c^2} \Theta
} 
+
...
&=
- X^{-1/2} \frac{1}{r c} \delta
+ X^{-3/2} \frac{1}{c^2} \Theta \\
&+ \rcap \cdot \lr{
    - \spacegrad X^{-1/2} \frac{1}{c} \delta
    - X^{-1/2} \frac{1}{c} \spacegrad \delta
    + X^{-3/2} \frac{\rcap}{c^2} \Theta
    + r \spacegrad X^{-3/2} \frac{1}{c^2} \Theta
    + r X^{-3/2} \frac{1}{c^2} \spacegrad \Theta
} \\
&=
- X^{-1/2} \frac{1}{r c} \delta
+ X^{-3/2} \frac{2}{c^2} \Theta \\
&
+ \rcap \cdot \lr{
    - \lr{  \frac{r \rcap}{c^2 X^{3/2}}  } \frac{1}{c} \delta
    - X^{-1/2} \frac{1}{c} \lr{  -\frac{\rcap \delta'}{c}  }
    + r \lr{ \frac{3 r \rcap}{c^2 X^{5/2}}  } \frac{1}{c^2} \Theta
    + r X^{-3/2} \frac{1}{c^2} \lr{ -\frac{\delta \rcap}{c}  }
} \\
&=
  X^{-1/2} \frac{1}{c^2} \delta'
- X^{-1/2} \frac{1}{r c} \delta
- X^{-3/2} \frac{2 r}{c^3} \delta
+ X^{-3/2} \frac{2}{c^2} \Theta 
+ X^{-5/2} \frac{3 r^2}{c^4} \Theta \\
&=
  X^{-1/2} \frac{1}{c^2} \delta'
+ X^{-3/2} \lr{ -\frac{\tau^2 - r^2/c^2}{r c} + \frac{2 r}{c^3} } \delta
+ X^{-5/2} \lr{ \frac{2(\tau^2 - r^2/c^2)}{c^2} + \frac{3 r^2}{c^4} } \Theta \\
\end{aligned}
\end{equation}
...
%%%+
%%%\Theta(\pm \tau - r/c) \lr{ \frac{r}{c^2} \lr{ \tau^2 - r^2/c^2 }^{-3/2} \rcap } \\
%%%&=
%%%- \frac{\rcap}{c} \lr{ \tau^2 - r^2/c^2 }^{-1/2} \delta\lr{ \pm \tau - r/c }
%%%+ \frac{\rcap r}{c^2} \lr{ \tau^2 - r^2/c^2 }^{-3/2} \Theta(\pm \tau - r/c).
%%%\end{aligned}
%%%\end{equation}
%%%
...
%%%+ \frac{r}{c^2 r} \lr{ \tau^2 - r^2/c^2 }^{-3/2} \Theta(\pm \tau - r/c)
%%%\\
%%%&+\quad
%%%\rcap \cdot \spacegrad \lr{
%%%- \frac{1}{c} \lr{ \tau^2 - r^2/c^2 }^{-1/2} \delta\lr{ \pm \tau - r/c }
%%%+ \frac{r}{c^2} \lr{ \tau^2 - r^2/c^2 }^{-3/2} \Theta(\pm \tau - r/c)
%%%}.
%%%\end{aligned}
%%%\end{equation}
...
%%%\delta\lr{ \pm \tau - r/c } \\
%%%&=
%%%-\frac{r}{c^3} \delta\lr{ \pm \tau - r/c } \lr{ \tau^2 - r^2/c^2 }^{-3/2}
...
%%%&=
%%%\frac{1}{c^2} \lr{ \tau^2 - r^2/c^2 }^{-3/2} \Theta(\pm \tau - r/c) \\
%%%&- \frac{r}{c^3} \lr{ \tau^2 - r^2/c^2 }^{-3/2} \delta\lr{ \pm \tau - r/c }
%%%+ \frac{3 r^2}{c^4} \Theta(\pm \tau - r/c) \lr{ \tau^2 - r^2/c^2 }^{-5/2}
%%%\end{aligned}
%%%\end{equation}
%%%
%%%We can now add up all the bits for the Laplacian, to find
%%%\begin{equation}\label{eqn:waveEquationGreens:520}
%%%\begin{aligned}
%%%\spacegrad^2 \frac{\Theta(\pm \tau - r/c)}{\sqrt{\tau^2 - r^2/c^2}}
%%%&=
%%%- \frac{1}{c r}
...
%%%    \lr{ \tau^2 - r^2/c^2 }^{-1/2}
%%%    \delta'\lr{ \pm \tau - r/c }
%%%-\inv{r c} \frac{ \tau^2 + r^2/c^2 }{\lr{\tau^2 - r^2/c^2}^{3/2}} \delta\lr{ \pm \tau - r/c } \\
%%%&+ \inv{c^2} \frac{ 2 \tau^2 + r^2/c^2 }{\lr{\tau^2 - r^2/c^2}^{5/2}}  \Theta(\pm \tau - r/c)
%%%\end{aligned}
%%%\end{equation}
