...
\end{equation*}
If the grade k, of \( A \) is greater than zero, so the grade \( k-1 \) and \( k+1 \) components of this are
\begin{equation*}
\begin{aligned}
...
Proving this lemma is left to the reader.
...
+
\lr{ \spacegrad \cross \Ba } \cross \Bb
+
