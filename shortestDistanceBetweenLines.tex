...
We can also conceptualize this as computing the trivector volume (parallelopiped with edges \( \Bp_2 - \Bp_1, \dcap_1, \dcap_2 \)), and then dividing out the bivector (parallelogram with edges \(\dcap_1, \dcap_2 \)), to find the vector (height) of the parallelopiped.
