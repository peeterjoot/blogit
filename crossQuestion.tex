...
\end{equation*}
Each of these triple product determinants represents the volume of the parallelopiped respectively formed by \( \xcap, \ycap, \zcap \) on one edge, and \( \vcap, \wcap \) on the other edges.  Each of these volumes is less than the total \( \ucap, \vcap \) parallelopiped area, and the factors \( u_x, u_y, u_z \) represent the weightings of the decomposition of those areas into each of these components, computed by evaluating a set of parallelopiped volumes.
