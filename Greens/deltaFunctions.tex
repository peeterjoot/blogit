...
%%\beginArtNoToc
%%
%%\generatetitle{Summary of some gradient related Green's functions}
...
\item Wave equation, \( \spacegrad^2 - (1/c^2) \partial_{tt} \), in 1D, 2D and 3D respectively
...
\item Spacetime gradient \( \LL = \spacegrad + (1/c) \partial_t \), satisfying \( \LL G(\Bx - \Bx', t - t') = \delta(\Bx - \Bx') \delta(t - t') \), in 1D, 2D, and 3D respectively
\begin{equation}\label{eqn:deltaFunctions:100}
\begin{aligned}
G(\Br, \tau)
&= \inv{2} \lr{ \rcap \pm 1 } \delta(\pm \tau - r/c) \\
G(\Br, \tau)
&=
\frac{
    \lr{\tau^2 - r^2/c^2}^{-3/2}
