...
\begin{dmath}\label{eqn:cramersga:160}
   x_k =
\frac{
\begin{vmatrix}
...
\begin{dmath}\label{eqn:cramersga:40}
\Ba x + \Bb y = \Bc.
\end{dmath}
Should we wish to solve for \( x \), we just wedge with \( \By \), and to solve for \( y \) we just wedge with \( \Bx \)
