...
\end{equation}
We've derived that line integral result in a different fashion previously, but it's interesting to see a different approach, so let's see if we can adapt it to non-scalar integrands.
