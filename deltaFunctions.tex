...
G(\Bx, \Bx') &= \frac{1}{4 j} H_0^{(1)}(k r), \quad \frac{1}{4 j} H_0^{(2)}(k r) \\
G\lr{ \Bx, \Bx' } &= -\frac{1}{4 \pi} \frac{e^{\pm j k r }}{r}.
\end{aligned}
\end{equation}
FIXME: verify the incoming 2D solution myself (Grok derived.)
...
\end{aligned}
\end{equation}
FIXME: Derive the incoming wave solutions for 2D and 3D cases.
