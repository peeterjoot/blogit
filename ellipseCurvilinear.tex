...
\begin{equation}\label{eqn:ellipseCurvilinear:20}
   \Bx(u, v) = u \lr{ \Be_1 \cos v + \beta \Be_2 \sin v },
\end{equation}
...
\begin{aligned}
   \Bx_1 &= \Be_1 \cos v + \beta \Be_2 \sin v \\
   \Bx_2 &= u \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v }.
\end{aligned}
\end{equation}
...
\begin{aligned}
\Bx_1 \wedge \Bx_2
&= \lr{ \Be_1 \cos v + \beta \Be_2 \sin v } \wedge u \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v } \\
&= u \gpgradetwo{ \lr{ \Be_1 \cos v + \beta \Be_2 \sin v } \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v } } \\
&= u \lr{
\beta \Be_{12} \cos^2 v - \beta \Be_{21} \sin^2 v
} \\
&= u \beta i,
\end{aligned}
\end{equation}
...
\Bx^1
   ...
   &= u \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v } \inv{ u \beta i } \\
   %&= \lr{ - \inv{\beta} \Be_1 \sin v + \Be_2 \cos v } (-i)
   &= \inv{\beta} \Be_2 \sin v + \Be_1 \cos v,
\end{aligned}
\end{equation}
...
\begin{aligned}
   ...
   &= - \lr{ \Be_1 \cos v + \beta \Be_2 \sin v } \cdot \inv{ u \beta i } \\
   %&= \lr{ \Be_1 \cos v + \beta \Be_2 \sin v } \frac{i}{ u \beta }
   &= \inv{u} \lr{ \inv{\beta} \Be_2 \cos v - \Be_1 \sin v }.
\end{aligned}
\end{equation}
...
\Bx^1 \cdot \Bx_1
&= \gpgradezero{
\lr{ \Be_1 \cos v + \beta \Be_2 \sin v } \lr{ \inv{\beta} \Be_2 \sin v + \Be_1 \cos v }
} \\
&=
\cos^2 v + \sin^2 v \\
&= 1,
...
\Bx^2 \cdot \Bx_2
&= \gpgradezero{
u \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v } \inv{u} \lr{ \inv{\beta} \Be_2 \cos v - \Be_1 \sin v }
} \\
&=
% \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v } \lr{ \inv{\beta} \Be_2 \cos v - \Be_1 \sin v }
\sin^2 v + \cos^2 v \\
&= 1,
\end{aligned}
\end{equation}
...
\Bx^1 \cdot \Bx_2
&= \gpgradezero{
\lr{ \inv{\beta} \Be_2 \sin v + \Be_1 \cos v } u \lr{ -\Be_1 \sin v + \beta \Be_2 \cos v }
} \\
&=
...
\Bx^2 \cdot \Bx_1
&= \gpgradezero{
\inv{u} \lr{ \inv{\beta} \Be_2 \cos v - \Be_1 \sin v } \lr{ \Be_1 \cos v + \beta \Be_2 \sin v }
} \\
&=
\inv{u} \lr{
