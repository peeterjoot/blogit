...
\subsection{Helmholtz Green's function in 1D.}
...
\paragraph{A strictly causal solution.}
...
%\paragraph{More specific boundary constraints.}
...
\subsubsection{Verification of the 1D Helmholtz Green's function.}
...
\subsubsection{Verifying the Green's function with convolution.}
...
\subsubsection{Expansion in series and taking the limit.}
...
\subsubsection{Verifying the Green's function.}
Observe that
...
\subsection{2D Green's function.}
\subsubsection{Evaluating the integral.}
...
\subsection{The 2D Laplacian Green's function.}
...
\subsubsection{An asymptotic expansion of The 2D Helmholtz Green's function.}
...
\subsubsection{Verifying the 2D Laplacian Green's function.}
...
\subsection{3D Green's function.}
