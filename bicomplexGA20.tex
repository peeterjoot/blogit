...
\begin{equation}\label{eqn:bicomplexGA20:360}
   \gpgrade{M N}{1}
   \sim
   \lr{ 0, n_{11} m_2 + m_{11} n_2 + n_{22} i m_2 - m_{22} i n_2 }.
\end{equation}
If we want the vector coordinates, those are
\begin{equation}\label{eqn:bicomplexGA20:380}
\begin{aligned}
   \gpgrade{M N}{1} \cdot \Be_1 &= \Real \lr{ n_{11} m_2 + m_{11} n_2 + n_{22} i m_2 - m_{22} i n_2 } \\
   \gpgrade{M N}{1} \cdot \Be_2 &= \Imag \lr{ n_{11} m_2 + m_{11} n_2 + n_{22} i m_2 - m_{22} i n_2 }.
\end{aligned}
\end{equation}
