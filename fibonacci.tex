...
\begin{dmath}\label{eqn:fibonacci:1060}
...
\end{dmath}
for which we have
\begin{dmath}\label{eqn:fibonacci:1140}
...
\end{dmath}
But
\begin{dmath}\label{eqn:fibonacci:1360}
\Delta F_n
= \alpha a^{n-1}.
\end{dmath}
so we must have
\begin{dmath}\label{eqn:fibonacci:1380}
a - 1 = 1,
\end{dmath}
or \( a = 2 \), as we already knew.  To fix the constant \( \alpha \) we utilize our boundary constraints, namely
